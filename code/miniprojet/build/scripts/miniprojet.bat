...
@rem ##########################################################################
@rem
@rem  miniprojet startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and MINIPROJET_OPTS to pass JVM options to this script.
...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %MINIPROJET_OPTS%  -classpath "%CLASSPATH%" com.kabli.managementsystem.Launch %*
...
:fail
rem Set variable MINIPROJET_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%MINIPROJET_EXIT_CONSOLE%" exit 1
exit /b 1
